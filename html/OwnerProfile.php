...
<nav>
    ...
    <div class="UserContainer">
        ...
        <a href="OwnerDashboard.php">Dashboard</a> <!-- Redirect to owner dashboard -->
        <a href="logout.php">Logout</a>
    </div>
</nav>

<div class="content">
    <h1 class="DashboardHeading">Owner Profile</h1>
    ...
    <div class="action-buttons">
        <a href="UpdateProfile.php" class="button">Edit Profile</a> <!-- Link to update profile page -->
    </div>
</div>
</body>
</html>
